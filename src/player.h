 ...
 */
    ...
    public:
        ...
        using SinkFn =
        std::function<std::unique_ptr<audio::Sink>(const audio::Source &, int)>;

        /// Type for functions that construct sources.
        using SourceFn =
        std::function<std::unique_ptr<audio::Source>(std::string_view)>;
         ...
         */
        void SetIo(const Response_sink &io);
